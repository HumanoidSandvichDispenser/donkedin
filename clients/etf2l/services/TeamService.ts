...
import type { Etf2lTeam, Etf2lTeamTransferResponse } from "../types";
export class TeamService {
  ...
  public getTeamTransfers(
    ...
    contentType?: string,
    accept?: string,
  ): CancelablePromise<Etf2lTeamTransferResponse> {
    return this.httpRequest.request({
      method: "GET",
      url: "/team/{clan_id}/transfers?limit={limit}&page={page}",
      path: {
        clan_id: clanId,
        limit: limit,
        page: page,
